...
function commit(at: number, rendered: number, total: number, components: CommitSummary['components']): CommitSummary {
  return { at, sinceInput: at - 1000, inputTs: 1000, gestureTs: 1000, inputType: 'click', rendered, hydrated: false, truncated: false, roots: ['CascadingEffect'], hotPath: ['CascadingEffect'], components, hasDurations: true, coarseClock: false, total, startedAt: null, walkMs: 0.3, priority: 1, didError: false };
}
