...
// than being tested in place of this app. `--ignore-lock` keeps both in the foreground: Astro 7 moves them to
// the background when it thinks a coding agent started them, and Playwright takes a server that exits for one
// that failed.
